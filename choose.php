...
<html lang="en" class="no-js">
	...
	<body>
		<div class="container">
			...
			<header>
				<h1>Choose your ingredients!<h3> Select all ingredients you have in your kitchen right now</h3></h1>
				<h1><span>While we will tell you the dish you should cook</span>	</h1>
			</header>
			<section>
